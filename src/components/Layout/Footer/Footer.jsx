        ...
        <footer className='footer'>
            <div className="container">
                <div className="footer__top">
                    ...
                    <h2 className="footer__top-logo">LM</h2>
                </div>
                <div className="footer__center">
                    <div className="footer__center-row">
                        <ul className='footer__center-ul'>
                            <li className="footer__center-li">Кухни</li>
                            <li className="footer__center-li">Спальни</li>
                            <li className="footer__center-li">Гостинные</li>
                        </ul>
                        <ul className='footer__center-ul'>
                            <li className="footer__center-li">Прихожие</li>
                            <li className="footer__center-li">Офисная мебель</li>
                            <li className="footer__center-li">Детская</li>
                        </ul>
                        <ul className='footer__center-ul'>
                            <li className="footer__center-li">Шкафы</li>
                            <li className="footer__center-li">Матрасы</li>
                            <li className="footer__center-li">Мягкая мебель</li>
                        </ul>
                    </div>
                    <p className="footer__center-address">г. Анапа, Анапское шоссе, <br/>
                        30 Ж/К Черное море
                    </p>
                </div>
                <div className="footer__bottom">
                    <div className="footer__bottom-left">
                        <p className='footer__bottom-left_sale'>
                            Акция
                        </p>
                        <p className='footer__bottom-left_new'>
                            Новинки
                        </p>
                    </div>
